...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        I have worked with <span className="font-medium"><a href="https://cybersecurity-excellence-awards.com/candidates/microsoft/" target="_blank">DSRE team</a></span> at{" "}
        ...
        <span className="font-medium"><a href="http://www.jaduniv.edu.in/" target="_blank">Jadavpur University</a></span> in 2020.
        ...
        I also spent my time as an{" "}
        <span className="font-medium">undergraduate researcher</span> under{" "}
        <span className="font-medium"><a href="https://scholar.google.co.in/citations?user=bDj0BUEAAAAJ&hl=en" target="_blank">Prof Ram Sarkar</a></span> and {" "}
        <span className="font-medium"><a href="https://scholar.google.co.in/citations?user=RMJLRiIAAAAJ&hl=en" target="_blank">Prof Sudip Kumar Naskar</a></span> working on machine learning and NLP projects.
      ...
      <p>
        ...
        learning about{" "}
        <span className="font-medium">GoLang and Distributed System</span>.
      </p>
    </motion.section>
  );
}